package com.johnjqc.devsu.persona.api.controller;
...
import com.johnjqc.devsu.persona.api.mapper.ClientApiMapper;
...
public class CustomerController implements CustomersApi {
    ...
    public ResponseEntity<CustomerPageResponse> getCustomers(
        ...
        Page<ClientServiceResponse> result = clientUseCase.findAll(pageable);
    ...
    public ResponseEntity<CustomerResponse> getCustomerById(
        ...
        ClientServiceResponse clientServiceResponse = clientUseCase.findById(customerId);
    ...
    public ResponseEntity<CustomerResponse> createCustomer(
        ...
        ClientServiceResponse serviceResponse = clientUseCase.create(serviceRequest);
    ...
    public ResponseEntity<CustomerResponse> updateCustomer(
        ...
        ClientServiceResponse serviceResponse = clientUseCase.update(customerId, serviceRequest);
        CustomerResponse response = clientApiMapper.toResponse(serviceResponse);
    ...
    public ResponseEntity<Void> deleteCustomer(
        ...
        clientUseCase.delete(customerId);
